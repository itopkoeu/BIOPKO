CREATE TABLE [fdp].[LIPS] (
    ...
    [KCMENG]           NUMERIC (15, 3) NOT NULL,
    [KCBRGEW]          NUMERIC (15, 3) NOT NULL,
    [KCNTGEW]          NUMERIC (15, 3) NOT NULL,
    [KCVOLUM]          NUMERIC (15, 3) NOT NULL,
    ...
    [LFIMG_FLO]        FLOAT (53)      NOT NULL,
    [LGMNG_FLO]        FLOAT (53)      NOT NULL,
    [KCMENG_FLO]       FLOAT (53)      NOT NULL,
    ...
    [KCMENGVME]        NUMERIC (15, 3) NOT NULL,
    [KCMENGVMEF]       FLOAT (53)      NOT NULL,
    ...
    [EXBWR]            NUMERIC (13, 2) NOT NULL,
    [BPMNG]            NUMERIC (13, 3) NOT NULL,
    [EXVKW]            NUMERIC (13, 2) NOT NULL,
    [CMPRE_FLT]        FLOAT (53)      NOT NULL,
    [KZPOD]            NVARCHAR (1)    NOT NULL,
    [LFDEZ]            NVARCHAR (1)    NOT NULL,
    [UMREV]            FLOAT (53)      NOT NULL,
    ...
    [SPE_EXP_DATE_EXT] NUMERIC (15)    NOT NULL,
    [SPE_EXP_DATE_INT] NUMERIC (15)    NOT NULL,
    [SPE_AUTH_COMPLET] NVARCHAR (1)    NOT NULL,
    [ORMNG]            NUMERIC (13, 3) NOT NULL,
    [SPE_ATP_TMSTMP]   NUMERIC (15)    NOT NULL,
    [SPE_ORIG_SYS]     NVARCHAR (1)    NOT NULL,
    [SPE_LIEFFZ]       NUMERIC (15, 3) NOT NULL,
    [SPE_IMWRK]        NVARCHAR (1)    NOT NULL,
    [SPE_LIFEXPOS2]    NVARCHAR (35)   NOT NULL,
    [SPE_EXCEPT_CODE]  NVARCHAR (4)    NOT NULL,
    [SPE_KEEP_QTY]     NUMERIC (13, 3) NOT NULL,
    [SPE_ALTERNATE]    NVARCHAR (40)   NOT NULL,
    [SPE_MAT_SUBST]    NVARCHAR (1)    NOT NULL,
    [SPE_STRUC]        NVARCHAR (3)    NOT NULL,
    [SPE_APO_QNTYFAC]  NUMERIC (5)     NOT NULL,
    [SPE_APO_QNTYDIV]  NUMERIC (5)     NOT NULL,
    [SPE_HERKL]        NVARCHAR (3)    NOT NULL,
    [SPE_BXP_DATE_EXT] NUMERIC (15)    NOT NULL,
